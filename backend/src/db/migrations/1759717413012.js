module.exports = {
    ...
    async up(queryInterface, Sequelize) {
        ...
        try {
                    ...
                    await queryInterface.createTable('sovereign_members', {
                        id: {
                            type: Sequelize.DataTypes.UUID,
                            defaultValue: Sequelize.DataTypes.UUIDV4,
                            primaryKey: true,
    ...
    async down(queryInterface, Sequelize) {
        ...
        try {
                    ...
                    await queryInterface.dropTable('sovereign_members', { transaction });
                    ...
                    await queryInterface.dropTable('dao_members', { transaction });
