...
import { create } from '../../stores/sovereign_members/sovereign_membersSlice'
...
Sovereign_membersNew.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
...
export default Sovereign_membersNew
