...
const EditGuestsPage = () => {
  ...
  return (
    <>
      ...
      <SectionMain>
        <SectionTitleLineWithButton icon={mdiChartTimelineVariant} title={'Edit guests'} main>
        {''}
  ...
  <FormField label='User' labelFor='user'>
        ...
        ></Field>
              ...
              <BaseButtons>
                ...
                <BaseButton type='reset' color='danger' outline label='Cancel' onClick={() => router.push('/guests/guests-list')}/>
              </BaseButtons>
            </Form>
          </Formik>
        </CardBox>
