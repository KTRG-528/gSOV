      ...
      <>
          ...
          <SectionMain>
            ...
            <CardBox>
                ...
                <div className={'mb-4'}>
                    <p className={'block font-bold mb-2'}>DocumentTitle</p>
                    <p>{documents?.document_title}</p>
                </div>

                <FormField label='CreatedDate'>
                    {documents.created_date ? <DatePicker
                      dateFormat="yyyy-MM-dd hh:mm"
                      showTimeSelect
                      selected={documents.created_date ?
                        new Date(
                          dayjs(documents.created_date).format('YYYY-MM-DD hh:mm'),
                        ) : null
                      }
                      disabled
                    /> : <p>No CreatedDate</p>}
