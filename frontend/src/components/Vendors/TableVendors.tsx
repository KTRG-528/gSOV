...
import { fetch, update, deleteItem, setRefetch, deleteItemsByIds } from '../../stores/vendors/vendorsSlice'
...
const TableSampleVendors = ({ filterItems, setFilterItems, filters, showGrid }) => {
  ...
  useEffect(() => {
    loadColumns(handleDeleteModalAction, `vendors`).then((newCols) =>
      setColumns(newCols),
    );
  }, []);
